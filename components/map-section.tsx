    ...
    <section className="py-24 bg-white dark:bg-gray-950">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-xl shadow-lg p-6 md:p-8 border border-gray-200 dark:border-gray-800">
          ...
          {/* Embedded Google Map */}
          <div className="w-full rounded-xl overflow-hidden border border-gray-300 dark:border-gray-700">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3680.68002082211!2d77.40114387451046!3d23.82809897863163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c426cfdfd1ed5%3A0xf2a9c89ea39b58d3!2sMANIT%20Bhopal!5e0!3m2!1sen!2sin!4v1702140000000!5m2!1sen!2sin"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
