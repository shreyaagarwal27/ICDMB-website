...
const advisoryCommittee = [
  { name: "Prof. Pramod M. Padole", institution: "VNIT Nagpur" },
  { name: "Prof. Kanagraj", institution: "IIT Guwahati" },
  { name: "Prof. Neelesh Kumar Jain", institution: "IIT Indore" },
  { name: "Prof. Sanjay Gupta", institution: "IIT Kharagpur" },
  { name: "Prof. B.P. Patel", institution: "IIT Delhi" },
  { name: "Prof. U.S Dixit", institution: "IIT Guwahati" },
  { name: "Prof. Inderdeep Singh", institution: "IIT Roorkee" },
  { name: "Prof. Palaniappan Ramu", institution: "IIT Madras" },
  { name: "Prof. Raguraman Munusamy", institution: "IIITDM Kancheepuram" },
  { name: "Prof. J. Ramkumar", institution: "IIT Kanpur" },
  { name: "Prof. Vikas V. Chaudhari", institution: "BITS Pilani" },
  { name: "Prof. Saroj Kumar Sarangi", institution: "NIT Patna" },
  { name: "Prof. Ashish B. Deoghare", institution: "NIT Silchar" },
  { name: "Prof. A.M Kuthe", institution: "VNIT Nagpur" },
  { name: "Prof. Ravi Kumar Mandava", institution: "IIITDM Kurnool" },
  { name: "Prof. Mihir Sarangi", institution: "IIT Kharagpur" },
  { name: "Prof. Susanta Panda", institution: "IIT Kharagpur" },
  { name: "Prof. Dillip Kumar Pratihar", institution: "IIT Kharagpur" },
  { name: "Prof. Sai Sidharth", institution: "IIT Hyderabad" },
  { name: "Prof. Sayed Ismail", institution: "NIT Warangal" },
]
