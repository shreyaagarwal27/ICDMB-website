...
import { Mail, FileText, Users, Download, CheckCircle2 } from "lucide-react"
          ...
          <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 hover:border-primary/50 transition-all duration-300 hover:shadow-lg dark:hover:shadow-primary/10">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  All papers will be reviewed to ensure high standards
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Plagiarism must be <span className="text-primary font-semibold">less than 15%</span>
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  AI content must be <span className="text-primary font-semibold">zero</span>
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Authors are required to submit the revised manuscript in the prescribed format, addressing all the review comments to the Technical Committee for final acceptance.
              </p>
            </div>
          </div>
