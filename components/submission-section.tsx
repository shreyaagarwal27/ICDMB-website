...
const academiaSteps = [
  ...
  { step: 2, title: "Peer Review", description: "All papers reviewed to ensure high standards" },
  { step: 3, title: "Revision", description: "Submit revised manuscript addressing all review comments" },
    ...
    <section id="submission" className="py-20 bg-white dark:bg-gray-950">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-heading">Full Paper</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 hover:border-primary/50 transition-all duration-300 hover:shadow-lg dark:hover:shadow-primary/10">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Academia and student authors intending to present Research Papers must submit the full paper in the
              prescribed format with maximum 10 to 12 pages by email (icdmb2026@gmail.com). All papers will be reviewed
            ...
            <div className="flex flex-col gap-2 mb-8">
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Plagiarism must be <span className="text-gray-900 dark:text-white font-semibold">less than 15%</span>
                </p>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  AI content must be <span className="text-gray-900 dark:text-white font-semibold">zero</span>
                </p>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Authors must submit revised manuscript addressing all review comments for final acceptance
                </p>
              </div>
            </div>
