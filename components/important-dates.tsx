        ...
        <div className="max-w-4xl mx-auto relative" ref={timelineRef}>
          ...
          <div className="relative z-10 space-y-8 md:space-y-12">
            {dates.map((item, index) => {
              ...
              const cardClasses = `p-4 md:p-6 rounded-xl backdrop-blur-md border transition-all duration-700 hover:scale-105 ${
                isHighlight
              ...
              return (
                <div
                  ...
                  data-index={index}
                  className="flex items-center gap-4 md:gap-8 pl-8 md:pl-0"
                >
                  {/* Left side - empty for odd indexes, content for even indexes */}
                  ...
                  {/* Center dot */}
                  <div className="absolute left-4 md:relative md:left-auto flex items-center justify-center flex-shrink-0">
                    <div
                  ...
                  {/* Right side - content for odd indexes on desktop, all items on mobile */}
                  <div className="flex-1 md:w-[calc(50%-2rem)] md:flex-none">
                    {/* Mobile view - always show all items */}
                    <div
                    ...
                    {/* Desktop view - only show for right side items (odd indexes) */}
                    {!isLeft && (
                      <div
